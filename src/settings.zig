...
/// The number of pixels per tile in width for cards
pub const pixels_per_unit_x: f32 = 44.0;
...
pub const colors = struct {
    pub const background = .{ .r = 0.52, .g = 0.8, .b = 0.92, .a = 1.0 };
